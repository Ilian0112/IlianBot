    ...
    switch (args[0].toLowerCase()) {
        ...
        var help2fr_embed = new Discord.RichEmbed()
            ...
            .setColor("#0000ff")
                ...
                .addField(PREFIX + "tradhelp", "**Pour affichier l'aide des** __**traductions**__ !")
        ...
        var help2en_embed = new Discord.RichEmbed()
            ...
            .setColor("#0000ff")
                ...
                .addField(PREFIX + "tradhelp", "**With this command you will be able to see the __**translation panel**__ !")
